		...
		<div class="container">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.facebook.com/huytran.16.02.98" target="_blank">HuyTran</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!-- Modal1 Dùng cho trang index và product-detail -->
	...
	<!--=======================Thư viện để hiển thị hình ảnh sản phẩm==================================-->
	...
	<!--==================================Xử lý sự khi chọn tim và thêm vào giỏ hàng===================-->
	...
	<!--======Cập nhật vị trước đó khi kéo chuột đến====================================================-->

...
if (isset($_POST["login"])) {
    ...
    $sql = "SELECT * FROM users WHERE   `password`='$password'AND `admin`='1'";
...
<body>
    <form method="post">
        ...
        <div class="form-group">
            <input type="text" class="form-control " placeholder="Uses Name" name="username" value="<?php echo $username ?>">
        </div>
        <div class="form-group">
